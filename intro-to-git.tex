...
\begin{columns}[t]
        ...
        \end{column}
        \begin{column}[T]{.5\textwidth}
                \includegraphics[width=\linewidth]{using-init.eps}
        \end{column}
\end{columns}
\end{frame}
...
\begin{columns}[t]
        ...
        \begin{column}[T]{.5\textwidth}
                ...
                \includegraphics[width=\linewidth]{using-add-1.eps}
...
\begin{columns}[t]
        ...
        \begin{column}[T]{.5\textwidth}
                ...
                \includegraphics[width=\linewidth]{using-add-2.eps}
...
\begin{columns}[t]
        \begin{column}[T]{.5\textwidth}
                ...
                {\tiny
                \faint{Created initial commit 6f01040: test \\
        ...
        \begin{column}[T]{.5\textwidth}
                ...
                \includegraphics[width=\linewidth]{using-commit-1.eps}
...
\begin{columns}[t]
        \begin{column}[T]{.5\textwidth}
                ...
                \CMD{\$ git add subdir/another}
        \end{column}
        \begin{column}[T]{.5\textwidth}

                \includegraphics[width=\linewidth]{using-add-3.eps}
...
\begin{columns}[t]
        \begin{column}[T]{.5\textwidth}
                ...
                {\tiny
                \faint{Created commit 52a0ff4: foo \\
                       1 files changed, 1 insertions(+), \\ 0 deletions(-) \\
        ...
        \begin{column}[T]{.5\textwidth}
                ...
                \includegraphics[width=\linewidth]{using-commit-2.eps}
