...
\begin{Verbatim}[commandchars=\\\{\}]
\CMD{\$ git clone git://repo.or.cz/git.git}
\end{Verbatim}
\vspace{\textheight}
\end{frame}
...
\begin{Verbatim}[commandchars=\\\{\}]
\CMD{\$ git clone git://repo.or.cz/git.git}
\blue{Initialize git/.git}
\blue{Initialized empty Git repository in /tmp/git/.git/}
...
{\tiny
\begin{Verbatim}[commandchars=\\\{\}]
\CMD{\$ git clone git://repo.or.cz/\red{git}.git}
\black{Initialize \red{git}/.git}
\black{Initialized empty Git repository in /tmp/\red{git}/.git/}
\faint{remote: Counting objects: 77575, done.}
\faint{remote: Compressing objects: 100% (26407/26407), done.}
\faint{remote: Total 77575 (delta 55750), reused 71007 (delta 49775)}
\faint{Receiving objects: 100% (77575/77575), 22.87 MiB | 798 KiB/s, done.}
...
{\tiny
\begin{Verbatim}[commandchars=\\\{\}]
\CMD{\$ git clone git://repo.or.cz/git.git} \red{build-tree}
