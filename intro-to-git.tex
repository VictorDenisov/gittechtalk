...
\begin{Verbatim}[commandchars=\\\{\}]
\CMD{\$ git clone git://repo.or.cz/project.git}
\end{Verbatim}
\vspace{\textheight}
\end{frame}
...
{\tiny
\begin{Verbatim}[commandchars=\\\{\}]
\CMD{\$ git clone git://repo.or.cz/\red{project}.git}
...
{\tiny
\begin{Verbatim}[commandchars=\\\{\}]
\CMD{\$ git clone git://repo.or.cz/project.git} \red{build-tree}
...
Writing objects: 100% (50/50), 10.45 KiB, done.
Total 50 (delta 44), reused 0 (delta 0)
refs/heads/master: f02acef11774f80f41883bbe2598dc5a8aabd62a ->
9ddc135d3de842e3da9bd8e18b3efc9a0727e5f6
To ssh+git://tachyon.jukie.net//home/git/into-to-git.git/
   f02acef..9ddc135  master -> master
\end{Verbatim}
}
\vspace{\textheight}
\end{frame}
...
\includegraphics[width=\linewidth]{remote-99.eps}
...
\faint{Initialize git/.git}
\faint{Initialized empty Git repository in /tmp/git/.git/}
\faint{remote: Counting objects: 77575, done.}
\faint{remote: Compressing objects: 100% (26407/26407), done.}
\faint{remote: Total 77575 (delta 55750), reused 71007 (delta 49775)}
\faint{Receiving objects: 100% (77575/77575), 22.87 MiB | 798 KiB/s, done.}
\faint{Resolving deltas: 100% (55750/55750), done.}
\faint{Checking out files: 100% (1396/1396), done.}
\faint{git clone git://repo.or.cz/git.git  5.31s user 1.32s system 11% cpu 57.855 total}
\end{Verbatim}
}
\vspace{\textheight}
\end{frame}
