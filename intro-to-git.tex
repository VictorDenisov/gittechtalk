...
git clone git://repo.or.cz/git.git  5.31s user 1.32s system 11% cpu 57.855 total
\end{Verbatim}
}
\vspace{\textheight}
\end{frame}
...
{\tiny
\begin{Verbatim}[commandchars=\\\{\}]
Initialize \red{git}/.git
Initialized empty Git repository in /tmp/\red{git}/.git/
remote: Counting objects: 77575, done.
remote: Compressing objects: 100% (26407/26407), done.
remote: Total 77575 (delta 55750), reused 71007 (delta 49775)
Receiving objects: 100% (77575/77575), 22.87 MiB | 798 KiB/s, done.
...
\cmd{\$ cd /tmp}
\CMD{\$ git clone git://repo.or.cz/git.git} \red{git-build-tree}
{\tiny
\begin{Verbatim}[commandchars=\\\{\}]
Initialize \red{git-build-tree}/.git
Initialized empty Git repository in /tmp/\red{git-build-tree}/.git/
remote: Counting objects: 77575, done.
remote: Compressing objects: 100% (26407/26407), done.
remote: Total 77575 (delta 55750), reused 71007 (delta 49775)
Receiving objects: 100% (77575/77575), 22.87 MiB | 798 KiB/s, done.
...
\begin{center}
        git remote add bart git://tachyon.jukie.net/into-to-git.git/
\end{center}
\vspace{\textheight}
\end{frame}
